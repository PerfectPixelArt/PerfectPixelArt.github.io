...
const messages = {
  ...
  photoMode: ['普通图片自动像素化', 'Pixelize ordinary images automatically'],
  stylized: ['已按保守尺寸完成普通图片像素化。', 'Ordinary image pixelized at a conservative resolution.'],
  stylizedHelp: ['未确认原始像素网格，已生成适度简化的像素图；网格分数为 0，不代表恢复了原始网格。可在更多设置中关闭普通图片自动像素化。', 'A rendering grid was generated without confirming an original pixel lattice. Grid confidence is 0. You can disable ordinary-image pixelization in More settings.'],
